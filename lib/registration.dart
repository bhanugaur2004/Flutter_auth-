...
// http.post(Uri.https('your_api_base_url', '/registration'))
      var response = await http.post(Uri.parse(registration),
//       var response = await http.post(Uri.http('localhost:3000', 'registration'),
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  CommonLogo(),
                  HeightBox(10),
                  "CREATE YOUR ACCOUNT".text.size(22).black.make(),
                  TextField(
